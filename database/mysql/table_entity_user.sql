CREATE TABLE E_USER(
	...
	LOGIN					CHAR(1) 	NOT NULL CHECK (LOGIN IN ('Y','N')),
...
CREATE TABLE E_USER_GOOGLE(
	USER_ID				VARCHAR(100)NOT NULL,
	GOOGLE_ID			VARCHAR(100)NOT NULL,
	TOKEN_GOOGLE		VARCHAR(250),
	MODIFY_DATE			TIMESTAMP	NOT NULL DEFAULT CURRENT_TIMESTAMP,
	CONSTRAINT PK_USER_GOOGLE			PRIMARY KEY (USER_ID),
	CONSTRAINT FK_USER_GOOGLE_USER_ID  FOREIGN KEY (USER_ID) REFERENCES E_USER(USER_ID)
);
